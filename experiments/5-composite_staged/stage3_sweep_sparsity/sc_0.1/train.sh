...
#SBATCH -o /n/netscratch/kozinsky_lab/Lab/demiranda/projects/sparse_delta/experiments/5-composite_staged/stage3_sweep_sparsity/sc_0.1/logs/%x_%j.out
#SBATCH -e /n/netscratch/kozinsky_lab/Lab/demiranda/projects/sparse_delta/experiments/5-composite_staged/stage3_sweep_sparsity/sc_0.1/logs/%x_%j.err

# stage 3 sweep, sparsity_coeff=0.1.
...
LAST_CKPT="$PROJECT_ROOT/runs/5-composite_staged/5-composite_staged_sweep-sc_0.1/last.ckpt"
if [[ -f "$LAST_CKPT" ]]; then
